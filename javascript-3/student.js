...
// Code Here
let groceries = ['water', 'gummy bears', 'hot cheetos'];
...
// You should now see the same thing you saw when you first loaded the page but you should now be able to add items to your grocery list with a dynamic total showing. 

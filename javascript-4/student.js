...
// CODE HERE
let faveColors = ['pink', 'maroon', 'white'];
...
let me = {
    firstName: 'Tramy',
    superHeroName: 'Thoughtful Tramy',
    homeTown: 'Witty, CA',
    superPowers: ['Punning', 'Poetic Justice Rhyming', 'Meme-ing'],
...
// Loop over the arr param and run a function called createLi(), which will take each item of the array as an argument. 
...
//////////////////Step 6////////////////////
// Lastly, create a function called redactInfo that will take in an obj as a parameter. 

...
// Have the function take the two parameters and re-run a string that says "NAMEPARAM loves LOVEPARAM" with the appropriate parameters in the string. e.g. "Bryan loves skateboarding"
...
// firstName will be your name as a string.
...
// Now lets use .filter to only get the number(s) greater than 100. 
...
// Code Here
let total = myNumbers.reduce(function(acc, index){
	return acc + index;
}, 0);
